import re
def generate_ihrsr_script(particle_num,angular_step,Cnsym,iter,box_size,search_range,maximum_ring,inplane_angular,cores,particle_stack,
...
'''%(particle_num,angular_step,ref_projection_num,iter,box_size,search_range,maximum_ring,has_sym,inplane_angular,particle_stack,cores,iter,
                pixel_size,inner_radius,outer_radius,search_step,search_step,pixel_size,inner_radius,outer_radius)
